...
{
    final long polyRev=0xedb88320L;
    long[] table=new long[256];
    long[] ini5Table=new long[100000];
    ...
    */
    ...
    /*public static void main(String args[])
    {
        ...
        bc.initializer();
        bc.mkini5Table();
        System.out.println(Arrays.toString(bc.table));
        //System.out.println(Arrays.toString(bc.ini5Table));
        ArrayList<String> result=bc.crackl4("331af0a1");
